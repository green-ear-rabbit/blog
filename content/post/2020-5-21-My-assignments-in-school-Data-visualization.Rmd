...
subtitle: My assignments at school 
...
VisualizationofdataingraphicalformatusingR.Submission deadline: 2020-03-23 14:00 (5% of final mark, no re-sit) 
 ...
 - Plot three of the following graphs with the dataset in the report:scatterplot, pie chart, bar graph, and box graph. For the scatter plot, please provide a linear regression, list the intercept, slope, and the correlation coeﬀicient using R. For the box graph, please add the mean value to each box. 
